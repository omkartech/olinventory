...
class Orders extends Admin_Controller 
{
	...
	*/
	public function create()
	{
        ...
        $this->data['vendor'] = $this->model_orders->getVendorData();
	...
	*/
	public function getProductValueById()
	{
		...
		if($product_id) {
			$product_data = $this->model_orders->getProductData($product_id);
	...
	*/
	...
	{
		$products = $this->model_orders->getActiveProductData();
	...
	*/
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	$this->data['products'] = $this->model_orders->getActiveProductData();      	
	...
	*/
			      ...
			      <div class="col-xs-12 table-responsive">
			        <table class="table table-striped">
			          ...
			          foreach ($orders_items as $k => $v) {
			          	...
			          	$product_data = $this->model_orders->getProductData($v['product_id']); 
	...
	public function getColor($productId){
        if($productId) {
            $data = $this->model_orders->getColorOnProduct($productId);
    ...
    public function getSize($colorId, $productId){
        ...
        $data = $this->model_orders->getSizeOnProduct($colorId, $productId);
        echo json_encode($data);
    }

    public function getUom($sizeId, $colorId, $productId){
        
        $data = $this->model_orders->getUomOnProduct($sizeId, $colorId, $productId);
        echo json_encode($data);
    }
