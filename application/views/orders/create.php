          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Vendor Name</label>
                    <div class="col-sm-7">
...
<script type="text/javascript">
  ...
  function getProductData(row_id)
  {
    var product_id = $("#product_"+row_id).val();    
      ...
      $.ajax({
        url: base_url + 'orders/getColor/'+product_id,
        type: 'get',
        dataType: 'json',
  ...
  $(document).on('change', '.color', function(){
    ...
    $.ajax({
      url: base_url + 'orders/getSize/'+color_id+'/'+product_id,
      type: 'get',
      dataType: 'json',
      success:function(response) {
  ...
  $(document).on('change', '.size', function(){
    ...
    $.ajax({
      url: base_url + 'orders/getUom/'+size_id+'/'+color_id+'/'+product_id,
      type: 'get',
      dataType: 'json',
      success:function(response) {
  ...
  $(document).on('click', '#createOrder', function(){
    ...
    $.ajax({
      url: base_url + 'orders/generate/'+vendor_id,
      type: 'post',
      data: {data : order},
      dataType: 'json',
      success:function(response) {
